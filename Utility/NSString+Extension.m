...
-(NSString*)repeated:(int)frequency{
    NSMutableArray *array = [NSMutableArray array];
    NSString* finalStr  = @"";
    for (int indx = 0; indx< self.length; indx++) {
        for (int fr = 0; fr < frequency; fr++) {
            [array addObject:[NSString stringWithFormat:@"%C", [self characterAtIndex:indx]]];
            finalStr = [finalStr stringByAppendingFormat:@"%C",[self characterAtIndex:indx]];
        }
    }
