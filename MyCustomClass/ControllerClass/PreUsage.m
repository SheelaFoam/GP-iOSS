...
@interface PreUsage()<UIPickerViewDataSource, UIPickerViewDelegate, CityTableDelegate, UITextFieldDelegate, ScanNumberDelegate> {
...
- (IBAction)city:(id)sender {
    ...
    if (cityList.count < 1) {
        [MailClassViewController showAlertViewWithTitle:GreatPlusTitle message:@"Please select State." delegate:nil tag:0];
    } else {
...
-(void) submitComplaint: (NSString *)city andState: (NSString *)state withPin: (NSString *)pin andDealerName: (NSString *)dealerName withComplaintType: (NSString *)complaintType andSubProduct: (NSString *)subProduct withSerialNo: (NSString *)serialNo andMRP: (NSString *)mrp withPurchaseDate: (NSString *)purchaseDate andProduct: (NSString *)product withLength: (NSString *)length andBreadth: (NSString *)breadth withThick: (NSString *)thick{
    ...
    [params setValue:@"" forKey:@"customer_name"];
    [params setValue:@"" forKey:@"customer_mobile"];
    [params setValue:@"" forKey:@"customer_address"];
