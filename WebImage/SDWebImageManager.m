...
- (void)dealloc
{
    (void)([downloadDelegates release]), downloadDelegates = nil;
    (void)([downloaders release]), downloaders = nil;
    (void)([cacheDelegates release]), cacheDelegates = nil;
    (void)([cacheURLs release]), cacheURLs = nil;
    (void)([downloaderForURL release]), downloaderForURL = nil;
    (void)([failedURLs release]), failedURLs = nil;
    [super dealloc];
}
